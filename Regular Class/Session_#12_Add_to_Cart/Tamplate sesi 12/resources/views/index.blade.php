    ...
    <div class="w-100 d-flex justify-content-center align-items-center flex-column gap-4" style="min-height: 50vh">
        ...
        <div class="w-50">
            ...
            <form action="{{ route('home.search') }}" class="d-flex justify-content-center align-items-center gap-4">
                @csrf
                <input type="text" class="form-control" placeholder="Search for a food ..." name="keyword"
                    value="{{ $search ?? '' }}">
    ...
    <div class="d-flex justify-content-around align-items-center flex-wrap gap-4 my-5">
        ...
        @foreach ($foods as $food)
            <div class="card" style="width: 18rem;">
                <img class="card-img-top"  src="{{ $food->image ? asset('img/' . $food->image) : 'https://placehold.co/400/orange/white?text=Food' }}"
                alt="food-image">
                <div class="card-body">
                    ...
                    <div class="d-flex w-100 justify-content-around align-items-center">
                        ...
                        <a href="{{ route('food.order', $food) }}" class="btn btn-dark">Order</a>
                    </div>
                </div>
            </div>
        @endforeach
