...
<body>
            ...
            <div
                ...
                <div class="w-75">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <!-- Photo -->
                        <div class="my-3">
                            <div class="d-block my-3" style="width: 150px; height: 150px; border: 1px solid black;">
                                <img src="" alt="food-cover"
                                    style="width: 100%; height: 100%; object-fit: cover; display: none;" id="imgPrev">
                            </div>
                            <input type="file" class="form-control" accept="img/*" name="photo" id="imgUp">
                        </div>
                        <!-- Name -->
    ...
    imgUp.addEventListener('change', () => {
        const files = imgUp.files[0];
        if (files) {
            imgPrev.src = URL.createObjectURL(files);
